...
export default function PaymentErrorModal({ onClose }) {
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
        ...
        <div className="flex justify-center">
          <button onClick={onClose} className="bg-[#d1a08a] hover:bg-[#c0917b] text-white font-medium py-3 px-12 rounded-full text-xl">Pay now</button>
        </div>
      </div>
    </div>
  );
